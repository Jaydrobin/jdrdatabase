...
| 갈래 | 판정 방식 | 항목 |
|---|---|---|
| 메모리·크기(`…Bytes`) | 보정 없이 기준선 대비 30% | `peakRssBytes`, `rssLastBytes`, `heapLastBytes`, 산출물 크기 |
