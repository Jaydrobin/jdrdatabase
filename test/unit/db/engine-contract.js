 ...
 * 구현과 분리되어 있어 `engine-contract.test.js`(wasm)와 `test/native/engine-native.test.js`(실제 rusqlite 엔진)가
 * 같은 `defineEngineContract(label, factory)`를 돌린다. 이 파일은 `.test.js`가 아니므로 러너가 직접 돌리지 않는다.
 */
